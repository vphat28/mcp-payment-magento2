...
define(
    ...
    function (ko, $, Component, validator) {
        ...
        return Component.extend({
            defaults: {
                template: 'MCPIntegration_Payment/payment/form',
                transactionResult: '',
                accordDChoice: '',
                accordDType: '',
                accordDGracePeriod: '',
            ...
            isActive: function () {
                return window.checkoutConfig.payment.mcp_gateway.active;
            },
            ...
            placeOrder: function () {
                if ($('#co-transparent-form-mcpgateway').validation('isValid')) {
                    return this._super();
                }
            ...
            initValidation: function () {
                $('#co-transparent-form-mcpgateway').on('keyup  paste', 'input, select, textarea', function() {
                    $('#co-transparent-form-mcpgateway').validation('isValid');
                });
            },
